...
export class AutoAsignarMateria {
  execute (materia: Materia, horarioActual: Horario[], termId: string, seccion: number = 1, laboratorioId?: string): Horario[] {
    return autoAsignarMateria(materia, horarioActual, termId, seccion, laboratorioId)
  }
}
